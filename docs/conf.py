...
module_dir = os.path.join(__location__, "../src/biocframe")
try:
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/biocpy/biocframe",
    "source_branch": "main",
...
htmlhelp_basename = "biocframe-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "biocframe Documentation", "Jayaram Kancherla", "manual")
]
